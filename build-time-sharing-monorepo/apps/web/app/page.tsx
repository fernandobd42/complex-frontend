...
import { CountButton } from '@repo/ui/count-button'
...
export default function Page(): JSX.Element {
  ...
  return (
    <main className={styles.main}>
      <div className={styles.description}>
        ...
        <div>
          <a href="https://vercel.com?utm_source=create-turbo&utm_medium=basic&utm_campaign=create-turbo" rel="noopener noreferrer" target="_blank">
            By <Image alt="Vercel Logo" className={styles.vercelLogo} height={24} priority src="/vercel.svg" width={100} />
          </a>
        </div>
      </div>
      ...
      <button onClick={() => setState((s) => s + 1)}>Custom Buttom {state}</button>
      <CountButton />
        ...
        <div className={styles.heroContent}>
          <div className={styles.logos}>
            ...
            <div className={styles.logo}>
              <Image alt="Turborepo" height={120} priority src="turborepo.svg" width={120} style={{ pointerEvents: 'none' }} />
            </div>
          </div>
